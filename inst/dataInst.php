            ...
            <div class="main_container">
                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        ...
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="index.php" class="site_title"><i class="fa fa-gear"></i> <span>INSTRUKTUR GRSB</span></a>
                        </div>
                ...
                <div class="right_col" role="main">               
                    ...
                    <section class="wrapper">
                        <h3>Data Instruktur GRSB Yogyakarta</h3>
                            ...
                            <div class="col-lg-12">
                                <div class="panel panel-success">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><i class="fa fa-users"></i> Data Instruktur </h3> 
                                    </div>
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            <?php
                                            $query1 = "select * from tb_instruktur where kd_instruktur = 1";
                                            ...
                                            <table class="table table-responsive table-bordered table-hover table-striped tablesorter">
                                                ...
                                                <?php while ($data = mysql_fetch_array($tampil)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="../admin/asset<?php echo $data['photo_instruktur']; ?>" width="60" height="60" class="img-thumbnail" /></td>                                                        
                                                    <?php
                                                }
                                                ?>
                                                </tbody>
                    ...
                    <footer>
                        <div class="">
                            <p class="pull-right">Dasboard Instruktur |
