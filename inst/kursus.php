                                ...
                                <div class="panel panel-success">
                                    ...
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            <?php
                                            $kd = $_SESSION['kd_instruktur'];
                                            $query1 = "select tb_jadwal_inst.*, tb_instruktur.*, tb_kelas.* from tb_kelas, tb_instruktur, tb_jadwal_inst where tb_jadwal_inst.kd_kelas=tb_kelas.kd_kelas and tb_kelas.kd_instruktur=tb_instruktur.kd_instruktur AND tb_instruktur.kd_instruktur=$kd";
