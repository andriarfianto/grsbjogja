...
<html lang="en">
    ...
    <body style="background-color: #f4f4f4">
        ...
        *********************************************************************************************************************************************************** -->
        ...
        <div id="login-page">
            <div class="container">	  	
                <form style="background-color:rgba(255,255,255,0.78)" class="form-login" method="post" action="prosesloginsiswa.php">
                    <center><h3 class="fa fa-lock"> <span"></span> GRSB Login Siswa<span"></span></h3></center>
                    <div class="login-wrap">
                        <div class="form-group">
                            <div  class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                <input id="kd_siswa" type="text" class="form-control" name="kd_siswa" value="" placeholder="Username">                                        
                            </div>
                        </div>
                        <div class="form-group">
                            <div  class="input-group">
                                <span class="input-group-addon"><i class="fa fa-unlock-alt"></i></span>
                                <input id="password_siswa" type="password" class="form-control" name="password_siswa" placeholder="Password">
                            </div>
                        </div>
