                                ...
                                <div class="panel panel-success">
                                    ...
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            <?php
                                            $query1 = "select * from tb_siswa where status = 'no'";
                                            ...
                                            <table class="table table-responsive table-bordered table-hover table-striped tablesorter">
                                                ...
                                                <?php while ($data = mysql_fetch_array($tampil)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><form action="calonSiswa.php" method="post" >
                                                                <a class="btn btn-sm btn-warning tooltips" data-placement="bottom" data-original-title="Edit Admin" href="editformsiswa.php?kd_siswa=<?php echo $data['kd_siswa']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
                                                                <a class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-original-title="Hapus Siswa" href="hapusFormSiswa.php?kd_siswa=<?php echo $data['kd_siswa']; ?>" onclick="return confirm('Yakin ingin menghapus data ini?')"><span class="glyphicon glyphicon-trash"></a>
                                                                <button type="submit" class="btn btn-sm btn-info tooltips" data-placement="bottom" data-original-title="Terima" ><span class="glyphicon glyphicon-baby-formula"></button>
                                                                <input type="text" name="aksi" value="terima" hidden="hidden">
                                                                <input type="text" name="kd_siswa" value="<?php echo $data['kd_siswa']; ?>" hidden="hidden">                                                            
                                                            </form>
                                        ...
                                        <div class="text-right">
                                            <a href="tambahCalonSiswa.php" class="btn btn-sm btn-success">Tambah Siswa <i class="fa fa-arrow-circle-right"></i></a>
                                        </div>
                                    </div> 
                                </div>
                            </div><!-- col-lg-12-->      	
