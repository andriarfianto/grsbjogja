        ...
        <div class="container body">
            ...
            <div class="main_container">
                ...
                <section class="wrapper">
                        ...
                        <?php
                        $query = mysql_query("SELECT * FROM tb_admin WHERE username='$_GET[username]'");
                        $data = mysql_fetch_array($query);
                        ?>
                        <div class="row mt">
                            <div class="col-lg-12">
                                <div class="form-panel">
                                    <form class="form-horizontal style-form" action="prosesEditAdmin.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Username</label>
                                            <div class="col-sm-10">
                                                <input name="" type="text" id="" disabled="disabled" class="form-control" placeholder="Username" value="<?php echo $data['username']; ?>" autofocus="on" required="required" />
                                                <input name="username" type="text" id="username" class="hidden"  value="<?php echo $data['username']; ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Nama Lengkap</label>
                                            <div class="col-sm-10">
                                                <input name="nama_admin" type="text" id="nama_admin" class="form-control" placeholder="Nama Lengkap" value="<?php echo $data['nama_admin']; ?>" autofocus="on" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Tanggal Lahir</label>
                                            <div class="col-sm-10">
                                                <input name="ttl_admin" type="date" id="ttl_admin" class="form-control" value="<?php echo $data['ttl_admin']; ?>" autofocus="on" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Jenis Kelamin</label>
                                            <div class="col-sm-10">
                                                <select name="jk_admin" id="jk_admin"  class="form-control" required />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="password_admin" type="text" id="password_admin" class="form-control" placeholder="Password" value="<?php echo $data['password_admin']; ?>" autofocus="on" required="required" />
                                            </div>
                                        </div>
