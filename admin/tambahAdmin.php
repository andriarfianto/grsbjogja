                        ...
                        <div class="row mt">
                            <div class="col-lg-12">
                                <div class="form-panel">
                                    <form class="form-horizontal style-form" action="prosesTambahAdmin.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="nama_admin" type="text" id="nama_admin" class="form-control" placeholder="Nama Lengkap" autofocus="on" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Tanggal Lahir</label>
                                            <div class="col-sm-10">
                                                <input name="ttl_admin" type="date" id="ttl_admin" class="form-control" autofocus="on" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="password_admin" type="text" id="password_admin" class="form-control" placeholder="Password" autofocus="on" required="required" />
                                            </div>
                                        </div>                                        
                                        <div class="form-group">
