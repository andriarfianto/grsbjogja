                    ...
                    <section class="wrapper">
                        ...
                        <div class="col-lg-4">
                            <form action='inst.php' method="POST">
                                <input type='text' class="form-control" style="margin-bottom: 4px;" name='qcari' placeholder='Cari berdasarkan Nama Instruktur' required /> 
                                ...
                                <div class="panel panel-success">
                                    ...
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            <?php
                                            $query1 = "select * from tb_instruktur";

                                            if (isset($_POST['qcari'])) {
                                                $qcari = $_POST['qcari'];
                                                $query1 = "SELECT * FROM  tb_instruktur 
                                                where nama_instruktur like '%$qcari%' ";
                                            }
                                            ...
                                            <table class="table table-responsive table-bordered table-hover table-striped tablesorter">
                                                ...
                                                <tr>
                                                    ...
                                                    <th>Kode Instruktur <i class="fa fa-sort"></i></th>
                                                    <th>Nama Instruktur <i class="fa fa-sort"></i></th>
                                                ...
                                                <?php while ($data = mysql_fetch_array($tampil)) {
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $data['kd_instruktur']; ?></td>
                                                        <td><?php echo $data['nama_instruktur']; ?></td>
                                                        <td><?php echo $data['jk_instruktur']; ?></td>
                                                        <td><?php echo $data['ttl_instruktur']; ?></td>
                                                        <td><img src="asset<?php echo $data['photo_instruktur']; ?>" width="60" height="60" class="img-thumbnail" /></td>
                                                        <td><center><a class="btn btn-sm btn-warning tooltips" data-placement="bottom" data-original-title="Edit Admin" href="editInst.php?kd_instruktur=<?php echo $data['kd_instruktur']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
                                                        <a class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-original-title="Hapus Siswa" href="hapusInst.php?kd_instruktur=<?php echo $data['kd_instruktur']; ?>" onclick="return confirm('Yakin ingin menghapus data ini?')"><span class="glyphicon glyphicon-trash"></a></center>
                                                    </td>
                                                    <?php
                                                }
                                                ?>
                                        ...
                                        <div class="text-right">
                                            <a href="tambahInst.php" class="btn btn-sm btn-success">Tambah Instruktur <i class="fa fa-arrow-circle-right"></i></a>
