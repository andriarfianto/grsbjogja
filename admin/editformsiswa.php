        ...
        <div class="container body">
            ...
            <div class="main_container">
                ...
                <section class="wrapper">
                        <h3><i class="fa fa-angle-right"></i> Calon Siswa &raquo; Edit</h3><br /><br />
                        ...
                        <div class="row mt">
                            <div class="col-lg-12">
                                <div class="form-panel">
                                    <form class="form-horizontal style-form" action="prosesEditformsiswa.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Kode Siswa</label>
                                            <div class="col-sm-10">
                                                <input type="text" disabled="disabled" class="form-control" placeholder="kd_siswa" value="<?php echo $data['kd_siswa']; ?>"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="ttl_siswa" type="date" id="ttl_siswa" class="form-control" value="<?php echo $data['ttl_siswa']; ?>" autofocus="on" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <select name="jam" id="jam" class="form-control">
                                    ...
                                    <option value="15.00-16.00">17.00-18.00</option>                                                                                    
                                </select>
                            </div>
                        </div> 
                                        <div class="form-group">
