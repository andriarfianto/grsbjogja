                                ...
                                <div class="panel panel-success">
                                    ...
                                    <div class="panel-body">
                                            ...
                                            <table class="table table-responsive table-bordered table-hover table-striped tablesorter">
                                                ...
                                                <?php while ($data = mysql_fetch_array($tampil)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $data['ttl_admin']; ?></td>
                                                        <td><img src="asset/<?php echo $data['photo_admin']; ?>" width="60" height="60" class="img-thumbnail" /></td>
                                                        <td><center><a class="btn btn-sm btn-warning tooltips" data-placement="bottom" data-original-title="Edit Admin" href="editAdmin.php?username=<?php echo $data['username']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
                                                        <a class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-original-title="Hapus Admin" href="hapusAdmin.php?username=<?php echo $data['username']; ?>" onclick="return confirm('Yakin ingin menghapus data ini?')"><span class="glyphicon glyphicon-trash"></a></center>
                                                    </td>
                                                    <?php
                                                }
                                                ?>
                                        ...
                                        <div class="text-right">
                                            <a href="tambahAdmin.php" class="btn btn-sm btn-success">Tambah Admin <i class="fa fa-arrow-circle-right"></i></a>
