                        ...
                        <div class="row mt">
                            <div class="col-lg-12">
                                <div class="form-panel">
                                    <form class="form-horizontal style-form" action="prosesTambahCalonSiswa.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Kode Siswa</label>
                                            <div class="col-sm-10">
                                                <input name="kd_siswa" type="text" id="kd_siswa" class="form-control" placeholder="Kode Siswa" autofocus="on" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <input name="nama_siswa" type="text" id="nama_siswa" class="form-control" placeholder="Nama Siswa" autofocus="on" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Tanggal Lahir</label>
                                            <div class="col-sm-10">
                                                <input name="ttl_siswa" type="date" id="ttl_siswa" class="form-control" autofocus="on" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="password_siswa" type="text" id="password_siswa" class="form-control" placeholder="Password" autofocus="on" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <a href="formsiswa.php" class="btn btn-sm btn-danger">Batal </a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
