        ...
        <div class="container body">
            ...
            <div class="main_container">
                ...
                <section class="wrapper">
                        ...
                        <?php
                        $query = mysql_query("SELECT * FROM tb_instruktur WHERE kd_instruktur='$_GET[kd_instruktur]'");
                        $data = mysql_fetch_array($query);
                        ?>
                        <div class="row mt">
                            <div class="col-lg-12">
                                <div class="form-panel">
                                    <form class="form-horizontal style-form" action="prosesEditInst.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Kode Instruktur</label>
                                            <div class="col-sm-10">
                                                <input name="" type="text" id="" disabled="disabled" class="form-control" placeholder="Username" value="<?php echo $data['kd_instruktur']; ?>" autofocus="on" required="required" />
                                                <input name="kd_instruktur" type="text" id="kd_instruktur" class="hidden"  value="<?php echo $data['kd_instruktur']; ?>"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Nama Lengkap</label>
                                            <div class="col-sm-10">
                                                <input name="nama_instruktur" type="text" id="nama_instruktur" class="form-control" placeholder="Nama Lengkap" value="<?php echo $data['nama_instruktur']; ?>" autofocus="on" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Tanggal Lahir</label>
                                            <div class="col-sm-10">
                                                <input name="ttl_instruktur" type="date" id="ttl_instruktur" class="form-control" value="<?php echo $data['ttl_instruktur']; ?>" autofocus="on" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Jenis Kelamin</label>
                                            <div class="col-sm-10">
                                                <select name="jk_instruktur" id="jk_instruktur"  class="form-control" required />
                                                <option> <?php echo $data['jk_instruktur']; ?> </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="password_instruktur" type="text" id="password_admin" class="form-control" placeholder="Password" value="<?php echo $data['password_instruktur']; ?>" autofocus="on" required="required" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <a href="inst.php" class="btn btn-sm btn-danger">Batal </a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
