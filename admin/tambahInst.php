            ...
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                 ...
                 <section class="wrapper">
                     ...
                     <h3>Tambah Data Instruktur</h3>

                        <div class="row mt">
                            <div class="col-lg-12">
                                <div class="form-panel">
                                    <form class="form-horizontal style-form" action="prosesTambahInst.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Kode Instruktur</label>
                                            <div class="col-sm-10">
                                                <input name="kd_instruktur" type="text" id="kd_instruktur" class="form-control" placeholder="Kode Instruktur" autofocus="on" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Nama Lengkap</label>
                                            <div class="col-sm-10">
                                                <input name="nama_instruktur" type="text" id="nama_instruktur" class="form-control" placeholder="Nama Instruktur" autofocus="on" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Tanggal Lahir</label>
                                            <div class="col-sm-10">
                                                <input name="ttl_instruktur" type="date" id="ttl_instruktur" class="form-control" autofocus="on" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Jenis Kelamin</label>
                                            <div class="col-sm-10">
                                                <select name="jk_instruktur" id="jk_admin"  class="form-control" required />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="password_instruktur" type="text" id="password_instruktur" class="form-control" placeholder="Password" autofocus="on" required="required" />
                                            </div>
                                        </div>                                        
                                        <div class="form-group">
